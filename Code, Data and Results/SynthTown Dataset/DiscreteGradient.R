#Using Gaussian Gradient algorithm
    ...
    for (k in 1:nnnk){
      ...
      for ( itera in 0:20 ) {
        ...
        la2_tilde=lapply(1:length(locations), function(n) {
          la2_tilde[[n]][la2_tilde[[n]]==0]=1e-20
          la2_tilde[[n]]
        } )
        ...
        lb2_tilde=lapply(1:length(locations), function(n) {
          lb2_tilde[[n]][lb2_tilde[[n]]==0]=1e-20
          lb2_tilde[[n]]
        } )
        
        la2=lapply(1:length(locations), function(n) {
          sqrt(lg2[[n]] * la2_tilde[[n]] / lb2_tilde[[n]] )
        } )
        ...
        lg2=lapply(1:length(locations), function(n) 1/2*lg_f[[n]] + 1/2*lg_b[[n]] )
        la2=lapply(1:length(locations), function(n) sqrt(lg2[[n]] * la2_tilde[[n]] / lb2_tilde[[n]] ) )
        lb2=lapply(1:length(locations), function(n) sqrt(lg2[[n]] / la2_tilde[[n]] * lb2_tilde[[n]] ) )
        lg2_old=lg2
      }
